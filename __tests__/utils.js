...
async function calculateSelectionData(selection) {
  ...
  */
  ...
  describe("describe", () => {
    ...
    beforeEach(() => {
      dom = new JSDOM('<!DOCTYPE html><html><body><div id="content">Hello world</div></body></html>');
  ...
  test("it tests the things", async () => {
    
    jest.spyOn(chrome.storage, "local").mockResolvedValue([{
    }]);
